...
using SportsRUsApp.Services;
using Microsoft.Practices.Unity;
using SportsRUsApp.IoC.Quartz;
using SportsRUsApp.Services.Data.Context;
using SportsRUsApp.Services.Data.UnitOfWork;

namespace SportsRUsApp.IoC
{
    /// <summary>
    ...
    public static partial class UnityHelper
    {
        ...
        {           
            ...
            container.BindInRequestScope<ISportsRUsContext, SportsRUsContext>();
