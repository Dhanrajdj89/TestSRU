...
namespace SportsRUsApp.Services
{
    public partial class RoleService : IRoleService
    {
        ...
        public RoleService(ISportsRUsContext context, ICategoryPermissionForRoleService categoryPermissionForRoleService, IPermissionService permissionService, IGlobalPermissionForRoleService globalPermissionForRoleService)
        {
