...
namespace SportsRUsApp.Services.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<SportsRUsContext>
    {
        ...
        {
            this.Seed(new SportsRUsContext());
        }

        protected override void Seed(SportsRUsContext context)
        {
            ...
            if (language == null)
            {
                ...
                if (!context.Category.Any())
                {
                    ...
                    const string exampleCatName = "SportsRUs";
                ...
                if (currentSettings == null)
                {
                    ...
                    var settings = new Settings
                    {
                        ...
                        AdminEmailAddress = "admin@sportsrus.in",
                        NotificationReplyEmail = "noreply@sportsrus.in",
                        SMTPEnableSSL = false,
                        Theme = "Metro",
                ...
                const string adminUsername = "admin@sportsrus.in";
                if (context.MembershipUser.FirstOrDefault(x => x.UserName == adminUsername) == null)
                {
                    ...
                    const string readMeText = @"<h2>Administration</h2>
                                    ...
                                    <p>Username: <strong>admin@sportsrus.in</strong><br />Password: <strong>Admin@123</strong></p>
