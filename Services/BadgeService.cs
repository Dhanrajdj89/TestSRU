...
using SportsRUsApp.Core.DataModel.Attributes;
...
namespace SportsRUsApp.Services
{
    public partial class BadgeService : IBadgeService
    {
        ...
        public BadgeService(ILoggingService loggingService, ILocalizationService localizationService,
            IMembershipUserPointsService membershipUserPointsService, IReflectionService reflectionService, ISportsRUsContext context)
        {
