/**    How To Create A Badge Class:
    ...
    1. Reference the following DLL in your assembly:
        ...
        SportsRUsApp.Core.dll (found in e.g. "MVCForum.Core\bin\Debug")

    2. Create a class. Add these references:

        using SportsRUsApp.Core.DomainModel;
        using SportsRUsApp.Core.DomainModel.Attributes;
        using SportsRUsApp.Core.Interfaces.API;
        using SportsRUsApp.Core.Interfaces.Badges;

    3. Inherit from the appropriate badge type interface, e.g. SportsRUsApp.Core.Interfaces.Badges.IVoteUpBadge
