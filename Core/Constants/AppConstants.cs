...
namespace SportsRUsApp.Core.Constants
{
    public static class AppConstants
    {
        public const int SaltSize = 24;
        public const string EditorType = "SportsRUsEditor";

        // Scheduled Tasks
        public const string DefaultTaskGroup = "SportsRUsTaskGroup";

        // Cookie names
        public const string LanguageIdCookieName = "LanguageCulture";
        public const string MemberEmailConfirmationCookieName = "SportsRUsEmailConfirmation";
